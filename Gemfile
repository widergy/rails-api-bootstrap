...
# A smart profiler for Ruby on Rails applications. It turns performance data into actionable insights
# gem 'skylight'
...
# Gives every ActiveRecord::Base object the possibility to do a deep clone that includes user specified associations
...
group :development, :test do
  ...
  # RSpec testing framework for Ruby on Rails as a drop-in alternative to its default testing framework, Minitest.
  gem 'rspec-rails', '~> 3.8'
  ...
  # Use for storing credentials and not uploading them to github. Loads ENV variables from .env file in base folder
  # gem 'dotenv-rails'
